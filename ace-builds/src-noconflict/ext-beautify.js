ace.define('ace/ext/beautify', ['require', 'exports', 'module', 'ace/config', 'ace/editor'], function(require, exports, module) {
    "use strict";
    ...
    exports.beautify = function(session) {
        ...
        var type = null;
        var detectedMode = getCurrentMode(editor);
        log('detecedmode', detectedMode);
        ...
        try {
            ...
            if(detectedMode != 'javascript'){
                log(new Error('need to enable other beautify types'));
            }
    ...
    var command_beautifySelection = {
        name: "beautify",
        exec: function(editor) {
            exports.beautify(editor.session);
        },
        bindKey: "Ctrl-Shift-B | Ctrl-B"
    };

    //hack: TODO - make this use session variable instead of editor
    var editor_for_event = null;
    ...
    config.defineOptions(Editor.prototype, "editor", {
        enableBeautify: {
            set: function(val) {
                if (val) {
                    editor_for_event = this;
                    this.commands.addCommand(command_beautifySelection);
                }
                else {
                    this.commands.removeCommand(command_beautifySelection);
                }
            },
            value: false
        }
...
*/
    ...
    if (typeof exports !== "undefined") exports.html_beautify = style_html;
